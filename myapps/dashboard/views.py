...
class IndexView(TemplateView):
    ...
    def get_template_names(self):
        if self.request.user.is_staff:
            return ['/Users/ishmeetkaur/Desktop/Amazon-master/amazon/myapps/mytemplates/index.html', ]
        else:
            return ['dashboard/index_nonstaff.html', '/Users/ishmeetkaur/Desktop/Amazon-master/amazon/myapps/mytemplates/index.html']
