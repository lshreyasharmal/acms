...
class ProductReportHTMLFormatter(ReportHTMLFormatter):
    print("yesss")
    filename_template = '/Users/ishmeetkaur/Desktop/Amazon-master/amazon/myapps/mytemplates/subdir/product_report.html'
...
class UserReportHTMLFormatter(ReportHTMLFormatter):
    print("finally!")
    filename_template = '/Users/ishmeetkaur/Desktop/Amazon-master/amazon/myapps/mytemplates/subdir/user_report.html'
